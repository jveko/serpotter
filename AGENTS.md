...
- **MinHash near-dupe suppression (D-f):** `serpotter-core/src/minhash.rs` — 64-dim MinHash over char 4-grams, Jaccard ≥ 0.9 greedy keep-first, runs after RRF at both search finalize sites; exact dupes stay URL-normalize + RRF.
